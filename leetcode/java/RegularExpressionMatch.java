...
public class RegularExpressionMatch {
	...
	public boolean isMatchComplex(String s, String p) {
		if (p.length() == 0) {
			return (s.length() == 0);
		}
    ...
    public boolean isMatch(String s, String p) {
        ...
        //case 2: when the second char of p is '*', complex
        else {	// p.charAt(1) == '*'
	...
	public static void main(String[] args) {
		...
		RegularExpressionMatch outer = new RegularExpressionMatch();
		...
		System.out.println("match aab, c*a*b -> " + outer.isMatchComplex("aab", "c*a*b"));
		// but this is false as d can be ignored, but c in front can't be ignored as * can only help one front
		System.out.println("match aab, cd*a*b -> " + outer.isMatchComplex("aab", "cd*a*b"));
