...
public class SpiralMatrixI_II_array {
    /*
     ...
     */
    // Algorithm: outer/inner loop of array with spiral mode
    ...
    public static int[][] generateMatrixII(int n) {
        ...
        // trick is to check and break the loop if next attempt to is invalid
        for (i = 0; i <= n / 2; i++) {
            if (i >= n - i) break;
