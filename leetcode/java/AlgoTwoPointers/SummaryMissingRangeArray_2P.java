...
public class SummaryMissingRangeArray_2P {
    /**
     * Given a sorted integer array without duplicates, return the summary of its ranges.
     * For example, given [0,1,2,4,5,7], return ["0->2","4->5","7"].
     */

    // Algorithm: two pointers. similar to MissingRange()
    ...
    public List<String> findMissingRanges_2P(int[] nums, int lower, int upper) {
